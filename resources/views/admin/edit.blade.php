            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('casis.update', $casis->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="nama" name="nama" value="{{ old('nama', $casis->nama) }}" required>
                                @error('nama')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3"
                                    required>{{ old('alamat', $casis->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-8 col-lg-9">
                                <select class="form-select @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin"
                                    ...
                                    <option value="laki-laki" @if (old('jenis_kelamin') == 'laki-laki' ||
                                            (isset($casis) && $casis->jenis_kelamin == 'laki-laki' && old('jenis_kelamin') == null)) selected @endif>Laki-laki
                                    </option>
                                    <option value="perempuan" @if (old('jenis_kelamin') == 'perempuan' ||
                                            (isset($casis) && $casis->jenis_kelamin == 'perempuan' && old('jenis_kelamin') == null)) selected @endif>Perempuan
                                    </option>
                                </select>
                                @error('jenis_kelamin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row mb-3">
                            <label for="jurusan_id" class="col-md-4 col-lg-3 col-form-label">Jurusan yang dipilih</label>
                            <div class="col-md-8 col-lg-9">
                                <select name="jurusan_id" id="jurusan_id"
                                    ...
                                    @foreach ($listJurusan as $jurusan)
                                        <option value="{{ $jurusan->id }}"
                                            {{ old('jurusan_id', $casis->jurusan_id) == $jurusan->id ? 'selected' : '' }}>
