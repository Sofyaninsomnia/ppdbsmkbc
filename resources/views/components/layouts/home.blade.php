  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="" class="logo d-flex align-items-center">
        ...
        <img src="assets/img/bc.png" alt="Logo" style="max-height: 50px; margin-right: 10px;">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">PPDB SMK BINA CENDEKIAX</span>
          </a>
          <div class="footer-contact pt-3">
            <p>Mertapada wetan jl kh wahid hasyim</p>
            <p class="mt-3"><strong>Hubungi</strong> <span>+1 5589 55488 55</span></p>
